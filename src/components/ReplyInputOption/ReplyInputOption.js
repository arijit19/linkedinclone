...
import styles from "./replyInputOption.module.css";
import * as actions from "../../store/actions/index";
import {updateObject, checkValidation} from "../../shared/Utility";

class ReplyInputOption extends Component {
    state = {
        value: "",
        config: {
            type: "any",
...
const mapDispatchToProps = dispatch => {
    return {
        likePost: (like)=> (dispatch(actions.likeReplyDatabase(like))),
        unlikePost: (likeDocID)=> (dispatch(actions.unlikeReplyDatabase(likeDocID))),
...
export default connect(mapStateToProps, mapDispatchToProps)(ReplyInputOption);